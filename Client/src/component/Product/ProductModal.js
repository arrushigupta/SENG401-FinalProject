...
function ImageCarousel(props) {
  return (
    ...
    >
      <img src={props.image} class="block w-full" alt="img not loading" />
    </div>
  );
}
...
export default function ProductModal({
  ...
  return (
    <>
      <div className="justify-center items-center mt-5 mb-5 overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative w-fit h-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex justify-start bg-red-700 p-5 border-b border-solid border-slate-200 rounded-t">
              <h3 className="grow text-3xl text-neutral-50 overflow-hidden">
                {name}
              </h3>
            ...
            <div className="relative p-6 flex justify-center bg-zinc-300">
              <div className="w-fit">
                ...
                <div className="flex items-start justify-start p-1 rounded-t">
                  ...
                  <p class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mx-2 my-2 overflow-hidden">
                    {description}
                  </p>
                </div>
              </div>
            ...
            {loggedInUserID.userID !== userID && (
              <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b bg-zinc-700">
                <input
                  ...
                  class="px-3 py-3 mr-7  placeholder-slate-400 text-slate-600 relative bg-slate-200 rounded text-sm border-0 shadow outline-slate-200 focus:outline-slate-300 focus:ring w-full"
                ></input>
